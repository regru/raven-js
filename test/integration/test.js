...
describe('integration', function() {
  ...
  describe('API', function() {
    ...
    it('should capture Raven.captureException', function(done) {
      ...
      iframeExecute(
        ...
        function() {
          var ravenData = iframe.contentWindow.ravenData[0];
          assert.isAbove(
            ravenData.exception.values[0].stacktrace.frames.length,
            1
          );
        }
      );
    ...
    it('should reject duplicate, back-to-back errors from captureError', function(
      done
    ) {
      var iframe = this.iframe;
      iframeExecute(
  ...
  describe('window.onerror', function() {
    ...
    it('should NOT catch an exception already caught via Raven.wrap', function(
      done
    ) {
      var iframe = this.iframe;
  ...
  describe('breadcrumbs', function() {
    ...
    it('should record an XMLHttpRequest without any handlers set', function(
      done
    ) {
      var iframe = this.iframe;
    ...
    it('should flush keypress breadcrumbs when an error is thrown', function(
      done
    ) {
      var iframe = this.iframe;
    ...
    it('should record history.[pushState|back] changes as navigation breadcrumbs', function(
      ...
      iframeExecute(
        ...
        function() {
          ...
          assert.ok(
            /\/test\/integration\/frame\.html$/.test(
              Raven._breadcrumbs[0].data.from
            ),
      ...
      iframeExecute(
        ...
        function() {
          ...
          window.isRestored = {
            ...
            xhrProtoOpen:
              originalBuiltIns.xhrProtoOpen === XMLHttpRequest.prototype.open,
            headAddEventListener:
              originalBuiltIns.headAddEventListener ===
    ...
    it('should not restore XMLHttpRequest instance methods', function(done) {
      ...
      iframeExecute(
        ...
        function() {
          ...
          window.isOnReadyStateChangeRestored =
